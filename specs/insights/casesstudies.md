...
> Sibling specs: [consultingoffer.md](consultingoffer.md), [powerbicustomvisualguide.md](powerbicustomvisualguide.md), [bestpracticeguide.md](bestpracticeguide.md)
...
Use the same tokens and interaction language as `../services/agentic-ai.md`:
