...
export function DataAndAnalyticsHero() {
    const s = useStyles();
    return (
                ...
                <div>
                    ...
                    <div className={s.btns}>
                        ...
                        <Button
                            ...
                            iconPosition="after"
                            onClick={() => document.getElementById("data-analytics-capabilities")?.scrollIntoView({ behavior: "smooth" })}
                        >
                            Get started
                        </Button>
                    </div>
                ...
                <div className={s.visual} aria-hidden="true">
                    ...
                    <div className={s.tile}>
                        ...
                        <div className={s.perfRow}>
                            ...
                            <div className={s.perfTrack}><div className={s.perfFill} style={{ width: "18%" }} /></div>
                        </div>
                        <div className={s.perfRow}>
                            <span className={s.perfLabel}>Median</span>
                            <div className={s.perfTrack}><div className={s.perfFill} style={{ width: "75%" }} /></div>
                        </div>
                    </div>
                    <div className={s.tile}>
                        <div className={s.tileTitle}>Active dashboards</div>
                        <div className={s.autoRow}><span>Power BI reports</span><span>432</span></div>
                        <div className={s.autoRow}><span>Embedded sessions</span><span>1,028</span></div>
                    </div>
                </div>
            </div>
        </section>
