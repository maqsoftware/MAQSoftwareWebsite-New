...
const useStyles = makeStyles({
    ...
    grid: { display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: "16px", "@media (max-width: 700px)": { gridTemplateColumns: "1fr" } },
    card: {
    ...
    name: { fontSize: "17px", fontWeight: 700, color: "var(--maq-black)", marginBottom: "8px" },
...
export function DataAndAnalyticsOutcomes() {
    const s = useStyles();
    return (
        <section className={s.section}>
            <div className={s.inner}>
                <div className={s.head}>
                    ...
                    <p className={s.sub}>What organizations gain when data &amp; analytics are delivered with engineering discipline.</p>
                </div>
