...
export function BusinessAppsCapabilities() {
    const s = useStyles();
        ...
        <section className={s.section} id="business-apps-capabilities">
            <div className={s.inner}>
                <div className={s.head}>
                    ...
                    <p className={s.sub}>
                        Four capability pillars that modernize legacy applications and automate operations
                        across the Microsoft business apps stack.
                    </p>
                </div>
