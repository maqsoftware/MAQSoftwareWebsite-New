...
export function BusinessAppsInsights() {
    const s = useStyles();
    return (
        <section className={s.section}>
            <div className={s.inner}>
                <div className={s.head}>
                    ...
                    <h2 className={s.title}>Our business apps and process automation insights</h2>
                    <p className={s.sub}>
                        See our research that goes into optimizing our business apps and process automation
                        service.
                    </p>
                </div>
