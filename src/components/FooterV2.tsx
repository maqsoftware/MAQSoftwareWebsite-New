...
const useStyles = makeStyles({
  // Full-bleed light band (Fluent neutral background 3) — lighter than the
  // CTA's neutral background 5 so the footer reads as distinct.
  surface: {
  ...
  logoMark: { width: "128px", height: "auto", display: "inline-flex", flexShrink: 0 },
  ...
  linkDisabled: { fontSize: "0.85rem", color: tokens.colorNeutralForegroundDisabled, cursor: "default" },
  bottom: {
    paddingTop: "24px",
  ...
  bottomText: { fontSize: "0.75rem", color: tokens.colorNeutralForeground3 },
  legalText: { fontSize: "0.75rem", color: tokens.colorNeutralForeground4 },
