...
export const INDUSTRIES: Industry[] = [
  { label: "Retail & consumer goods", sub: "Stores, E-commerce & Consumer Brands", desc: "Embed AI across customer experience, supply chain, and store operations to respond in real time.", to: "/industries/retail",
    icon: <ShoppingBag /> },
  ...
  { label: "Technology", sub: "Software & Digital Natives", desc: "Integrate AI across the SDLC so engineering teams spend less time on rework and more on shipping.", to: "/industries/technology",
    icon: <Monitor /> },
  { label: "Manufacturing", sub: "Industrial & Supply Chain", desc: "Connect plant operations, supply chain, and procurement on one platform, with AI agents that handle vendor receipts end to end.", to: "/industries/manufacturing",
    icon: <Wrench /> },
  { label: "Healthcare & life sciences", sub: "Providers, Payers & Life Sciences", desc: "Turn fragmented health data into safer clinical decisions, with HIPAA and 21 CFR Part 11 built in.", to: "/industries/healthcare-life-sciences",
    icon: <Ambulance /> },
  { label: "Public Sector", sub: "Government & Mission", desc: "Move citizen services, policy decisions, and program analytics to AI-grounded platforms, aligned to FedRAMP and CJIS.", to: "/industries/public-sector",
    icon: <Earth /> },
];
