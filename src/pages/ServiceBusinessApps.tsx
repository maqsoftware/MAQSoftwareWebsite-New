        ...
        <div className={s.heroGrid}>
          <div>
            <span className={s.eyebrow}>
              Business apps &amp; process automation
            </span>
            <h1 className={s.h1}>
              AI-native business apps on Microsoft Power Platform
            </h1>
            <p className={s.heroSub}>
              Low-code and pro-code apps built on Power Apps, Dynamics 365, and
              Microsoft 365 — paired with Copilot Studio agents and Power
              Automate flows that retire manual handoffs and embed AI into
              everyday operations.
            </p>
            ...
            <div className={s.tile}>
              ...
              <div className={s.pulseRow}>
                ...
                <span className={s.pulseLabel}>
                  42 flows running · 0 failed in 24h
                </span>
              </div>
            </div>
            <div className={s.tile}>
        ...
        <div className={s.inner}>
          <div className={s.head}>
            ...
            <h2 className={s.title}>
              Our business apps and process automation capabilities
            </h2>
            <p className={s.secSub}>
              Four capability pillars that modernize legacy applications and
              automate operations across the Microsoft business apps stack.
            </p>
          </div>
          ...
          <a
            ...
            rel="noreferrer"
          >
            See business apps &amp; process automation case studies{" "}
            <ArrowRight16Regular />
          </a>
        </div>
      </section>
      ...
      <section className={s.sectionAlt}>
        <div className={s.inner}>
          <div className={s.headCentered}>
            ...
            <p className={s.secSub}>
              What organizations gain when legacy apps and manual processes are
              modernized with engineering discipline.
            </p>
          </div>
        ...
        <div className={s.inner}>
          <div className={s.head}>
            ...
            <h2 className={s.titleSm}>
              How clients are modernizing their business apps
            </h2>
          </div>
          ...
          <a
            ...
            rel="noreferrer"
          >
            See all application modernization case studies{" "}
            <ArrowRight16Regular />
          </a>
        </div>
      </section>
      ...
      <section className={s.section}>
        <div className={s.inner}>
          <div className={s.head}>
            ...
            <h2 className={s.titleSm}>
              Our business apps and process automation insights
            </h2>
            <p className={s.secSub}>
              See our research that goes into optimizing our business apps and
