      ...
      sections={[
        {
          ...
          practices: [
            ...
            { title: "3. Push to data mart", body: "If using Azure Databricks (ADB), process notebooks in parallel (versus sequentially) to reduce refresh time and identify platform run failures. If using tabular models, cross-check the data consistency between data mart and tabular models. For non-cloud environments using SSIS or other ETL tools, implement similar checks for staging against data mart publish — for example, data profiling in SSIS." },
