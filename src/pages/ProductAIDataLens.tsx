        ...
        <div className={s.heroGrid}>
          <div>
            ...
            <p className={s.heroSub}>
              Transform how users interact with data by enabling
              natural-language queries and delivering instant, intelligent
              insights. Unlock a new way to interact with your data.
            </p>
