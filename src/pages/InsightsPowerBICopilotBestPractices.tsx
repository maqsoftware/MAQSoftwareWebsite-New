...
export function InsightsPowerBICopilotBestPractices() {
  return (
    <GuideArticle
      ...
      references={[
        { label: "Build AI-ready semantic models with Power BI Copilot", href: "https://maqsoftware.com/insights/power-bi-copilot-best-practices", source: "MAQ Software" },
      ...
      continueReading={{
        image: "https://maqsoftware.com/img/blog/BPG006-main.jpg",
