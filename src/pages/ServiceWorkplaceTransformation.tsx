...
const caseStudies: CaseStudy[] = [
  ...
  },
  {
    tag: "AI adoption",
    title:
      "Scaling AI for every customer and every developer with MAQ Software",
    teaser:
        ...
        <div className={s.heroGrid}>
          <div>
            ...
            <p className={s.heroSub}>
              ...
              management that turn rollouts into measurable usage, not
              shelfware.
            </p>
        ...
        <div className={s.inner}>
          <div className={s.head}>
            ...
            <p className={s.secSub}>
              Four capability pillars that modernize employee experiences and
              unlock the full value of your Microsoft 365 investment.
            </p>
          </div>
      ...
      <section className={s.section}>
        <div className={s.inner}>
          <div className={s.head}>
            ...
            <h2 className={s.titleSm}>Our workplace transformation insights</h2>
            <p className={s.secSub}>
              See our research that goes into optimizing workplace productivity
              and collaboration.
            </p>
          </div>
